...
var AppComponent /*implements OnInit*/ = (function () {
    // items;
    function AppComponent /*implements OnInit*/() {
    }
    AppComponent /*implements OnInit*/ = __decorate([
        core_1.Component({
            selector: 'my-app',
            moduleId: module.id,
...
exports.AppComponent /*implements OnInit*/ = AppComponent /*implements OnInit*/;
